	...
	<div class="container-fluid">
		...
		<div class="header__content">
			<h1 class="header__title">
				Подберем лучший автомобиль по вашему бюджету </h1>
			<p class="header__subtitle">Осматриваем автомобили перед покупкой по всей Латвии, Литве.</p>
			<a href="#pop-up-about" class="btn header__btn btn__small popup-about">О нас</a>
